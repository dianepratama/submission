    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-8 mx-auto">
            <div class="flex flex-col items-center text-center">
                <a href="#">
                    <img class="w-auto h-7" src="https://www.krakatausteel.com/images/reverselogo.png" alt="">
                </a>
                ...
                <div class="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
                    <button
                        ...
                        onclick=" window.open('https://youtu.be/5j9RVshYfjA?start=68&fs=1','_blank')">
                        ...
                        <span class="mx-1">View Company Profile</span>
                    </button>
                </div>
            </div>
